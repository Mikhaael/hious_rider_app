...
import 'package:hious_rider_app/extensions.dart';
import 'package:hious_rider_app/utils/auth/user_repository.dart';

import '../designs/routes.dart';
import '../enums.dart';
  ...
  void _handleResult(String? result, BuildContext context) {
    if (result == null) {
      Navigator.pushNamedAndRemoveUntil(
          context, Routes.splash, ModalRoute.withName(Routes.welcome));
    } else {
